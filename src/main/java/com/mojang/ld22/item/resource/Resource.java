...
public class Resource {
	...
	public static Resource strawberrySeeds = new PlantableResource("SSeeds", 5 + 4 * 32, Color.get(-1, 10, 40, 50), Tile.wheat, Tile.farmland);
	public static Resource wheat = new Resource("Wheat", 6 + 4 * 32, Color.get(-1, 110, 330, 550));
	
	// Name, Sprite, Color, Heal, Stamina Cost
	...
	public static Resource strawberry = new FoodResource("SBerry", 9 + 4 * 32, Color.get(-1, 100, 300, 500), 1, 3);
