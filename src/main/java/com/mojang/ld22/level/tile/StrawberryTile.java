...
public class StrawberryTile extends Tile {
	...
	private void harvest(Level level, int x, int y) {
		...
		for (int i = 0; i < count; i++) {
			level.add(new ItemEntity(new ResourceItem(Resource.strawberrySeeds), x * 16 + random.nextInt(10) + 3, y * 16 + random.nextInt(10) + 3));
		}
		...
		for (int i = 0; i < count; i++) {
			level.add(new ItemEntity(new ResourceItem(Resource.strawberry), x * 16 + random.nextInt(10) + 3, y * 16 + random.nextInt(10) + 3));
		}
